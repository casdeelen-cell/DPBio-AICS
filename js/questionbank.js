...
const QUESTIONBANK = {
  ...
  "C2.2": [
    ...
    {
      q: "A researcher compares nerve conduction velocity in two axons of identical diameter: one wrapped in a myelin sheath and one left unmyelinated. The myelinated axon conducts impulses several times faster. If a drug were applied that selectively destroyed the myelin sheath without directly damaging the axon itself, what effect would this be expected to have on conduction velocity?",
      options: ["Conduction velocity would decrease substantially, since the impulse could no longer jump between nodes of Ranvier and would instead need to depolarise continuously along the entire membrane", "Conduction velocity would increase, since removing myelin would expose more of the membrane to direct stimulation", "Conduction velocity would be unaffected, since myelin plays no role in determining impulse speed", "The axon would be entirely unable to conduct any impulse at all once demyelinated"],
      correct: 0,
      explanation: "Myelin normally allows saltatory conduction, in which the nerve impulse effectively jumps between exposed nodes of Ranvier rather than needing to depolarise continuously along the axon's entire length; destroying the myelin sheath would remove this insulation, forcing the impulse back into the much slower continuous conduction mode, substantially reducing conduction velocity even though the axon itself remains structurally intact, a pattern seen clinically in demyelinating conditions such as multiple sclerosis."
    },
    {
