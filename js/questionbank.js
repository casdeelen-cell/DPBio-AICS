...
const QUESTIONBANK = {
  ...
  "D3.3": [
    ...
    {
      q: "Newborn babies, who cannot yet shiver effectively, rely heavily on a specialised tissue called brown adipose tissue to generate heat when their body temperature falls. Unlike ordinary muscle contraction, this tissue generates heat through 'uncoupled' cellular respiration. What does this uncoupling involve?",
      options: ["A protein in the mitochondrial membrane allows hydrogen ions to flow back into the matrix without passing through ATP synthase, releasing the stored energy directly as heat rather than capturing it as ATP", "The tissue stops respiring entirely, and heat is instead generated purely by the physical breakdown of fat molecules", "Uncoupled respiration produces significantly more ATP per glucose molecule than normal respiration, and this extra ATP is converted directly into heat", "The mitochondria in brown adipose tissue lack an electron transport chain entirely, generating heat through fermentation instead"],
      correct: 0,
      explanation: "In brown adipose tissue, a specific protein embedded in the inner mitochondrial membrane allows hydrogen ions to flow back into the matrix without passing through ATP synthase, bypassing the normal route used to generate ATP; because this proton flow no longer drives ATP production, virtually all of the energy that would otherwise have been captured as ATP is instead released directly as heat, making this 'uncoupled' respiration a dedicated heat-generating mechanism rather than an ATP-generating one, particularly important for newborns who cannot yet shiver effectively to generate heat by muscle contraction."
    },
    {
